...
namespace project_kel8
{
    public partial class MasterGudang : Form
    {
        ...
        {
            this.getNamaKecamatanTableAdapter.FillBy(this.dsEkspedisi.getNamaKecamatan, empty);
        }
